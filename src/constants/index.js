...
I’m passionate about using data to solve real-world problems, from analyzing products trends to optimizing statistical strategies. Skilled in SQL, Python, and Power BI, I create dashboards, build models, and deliver actionable insights.
...
In my free time, I stay updated on emerging AI/ML trends and contribute to open-source projects. Feel free to explore my portfolio and reach out for collaboration!
`; 
...
export const EXPERIENCES = [
  {
    ...
    technologies: ["Python", "SQL", "Power BI", "Data Analytics", "Machine Learning", "Forecasting", "Snowflake", "AWS", "Salesforce"],
  },
  {
